...
function App() {
    const requestId = ("" + Math.random()).substring(2, 8);
    emailjs.init({
        publicKey: import.meta.env.VITE_MAILJSPUBLICKEY,
    });
    useEffect(() => {
        document
        ...
        <>
            ...
            <section className="flex w-full justify-between items-center max-w-6xl mt-24">
                <div className="flex flex-col gap-3">
                    ...
                    <h1 className="text-6xl font-bold">Gaurav Chaubey</h1>
                    <p className="max-w-xl mt-2 font-semibod text-slate-600">
                        Experienced software engineer adept in product
                        development and management, crafting efficient code and
                        driving project success through strategic planning and
                        execution. Leveraging three years of expertise to
                        innovate, optimize, and deliver high-quality solutions
